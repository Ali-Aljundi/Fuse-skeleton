...
export class AmChartComponent { 
  ...
  public panels: any = [
  {sizeX: 1, sizeY: 1, row: 0, col: 0, content: '<div class="content"> @import { FirstChartComponent } from \'./am-chart/first-chart/first-chart.component\'; <app-first-chart></app-first-chart></div>'},
